...
module.exports = {
    ...
    RunServer: function () {
        ...
        JSON.parse(fs.readFileSync('metadep.json', 'utf8'))['component'].forEach((component) => file += fs.readFileSync(path.join(__dirname, '../../src/component/'+component+'/'+component+'.html'), 'utf-8'));
